...
--outFileNamePrefix $OUTDIR_SAMPLE/${SAMPLE}.star. \
...
BAM=${OUTDIR_SAMPLE}/${SAMPLE}.star.Aligned.sortedByCoord.out.bam
...
BAM_COLLATE=${OUTDIR_SAMPLE}/${SAMPLE}.star.Aligned.sortedByCoord.out.samtools_tempcollate.bam
BAM_FIXMATE=${OUTDIR_SAMPLE}/${SAMPLE}.star.Aligned.sortedByCoord.out.samtools_tempfixmate.bam
BAM_SORT=${OUTDIR_SAMPLE}/${SAMPLE}.star.Aligned.sortedByCoord.out.samtools_tempsort.bam
BAM_MARKDUP=${OUTDIR_SAMPLE}/${SAMPLE}.star.Aligned.sortedByCoord.out.samtools_markdup.bam
STAT_FILE=${OUTDIR_SAMPLE}/${SAMPLE}.star.Aligned.sortedByCoord.out.samtools_markdup_stats.txt
